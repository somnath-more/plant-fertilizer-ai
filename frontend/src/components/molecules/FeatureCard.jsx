...
export const FeatureCard = ({ icon: Icon, title, description ,onCardClick}) => (
  <div onClick={onCardClick} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-1 cursor-pointer">
